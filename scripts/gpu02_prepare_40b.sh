...
output_size="82252673728"
output_sha256="7452b1412919d6724172dfe4a76b01605ccdb20522873dea6f06df4ea76c8ac7"
...
output="$model_dir/evo2-40b-bf16.evo2"
...
hf_home="${EVO2C_HF_HOME:-/build/grp_icg/users/tang/.cache/huggingface}"
