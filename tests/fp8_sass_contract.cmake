if(NOT DEFINED EVO2C_CUDA_BINARY OR NOT DEFINED EVO2C_CUOBJDUMP)
  message(FATAL_ERROR "FP8 SASS audit requires EVO2C_CUDA_BINARY and EVO2C_CUOBJDUMP")
endif()

execute_process(
  COMMAND "${EVO2C_CUOBJDUMP}" --dump-sass --dump-ptx "${EVO2C_CUDA_BINARY}"
