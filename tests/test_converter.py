...
from evo.format import (
    ...
    EVO2_PROFILE_VALUE,
    ESMC_PROFILE_VALUE,
    GENEB_DECODER_PROFILE_VALUE,
    GENEB_ESM_PROFILE_VALUE,
    GENEB_BERT_PROFILE_VALUE,
    GENEB_DNA_GPT_PROFILE_VALUE,
    GENEB_CUSTOM_ENCODER_PROFILE_VALUE,
    GENEB_EVO1_PROFILE_VALUE,
    GENEB_HYENADNA_PROFILE_VALUE,
    GENEB_JANUSDNA_PROFILE_VALUE,
    GENEB_MAMBA_PROFILE_VALUE,
    GENEB_GPT2_PROFILE_VALUE,
    GENEB_OLMO_PROFILE_VALUE,
    GENEB_ROFORMER_PROFILE_VALUE,
    GENEB_SEQUENCE_CNN_PROFILE_VALUE,
