...
"""Audit pinned GENA-LM-T2T-Multi B94 tokenizer parity and B77 relocation."""
...
REVISION = "4633e5a1ada905bb7afee6877d71cc12578a95a5"
...
def main() -> int:
    ...
    report = {
        "schema_version": 1,
        "kind": "geneb-gena-lm-t2t-multi-tokenizer-parity-audit",
        "status": "passed",
        "source": {
            "repo": SOURCE_REPO,
            "revision": REVISION,
