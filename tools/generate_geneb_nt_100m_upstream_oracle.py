...
"""Generate the pinned NT-v2-100M GENEB vector with official HF code."""
...
RUNTIME_ID = "geneb-nt-v2-100m-ms"
...
CATALOG_CONTRACT_SHA256 = (
    "dbc4d1e7ddfb6753a60620182b39aacf2c43b836da6844e89c0189e117211d10"
)
...
EXPECTED_FILES = {
    ...
    "README.md": (6345, "2219ab6eb94367b793498f7eda6f6f3535863d6101a07f792c68e8ce8e31b146"),
    "config.json": (1064, "82399c099aaacdc69e1a3dcdb95e62ff5523a0f9b46cfc5bd960f4c7dc390b29"),
    "esm_config.py": (14876, "a44e859baa08465ecdcd76b0a73f6e4fe011245a212931c403de1149ae9613ec"),
    "jax_model/hyperparams.json": (659, "456b0e6dba82b0ea2cd86f463f1f5421ad7db9c9bacc46ba83b336b0a0e56b54"),
    "jax_model/pytree_ckpt.joblib": (387386947, "52174442aff5ec4127b790c3ef1c5537f2e297fb33fd7d7fe21159baececa539"),
    "model.safetensors": (391597600, "60d5fe10281f7bf0436e990a55a3cf635eeabaf63b0e3ca4dc73838264d329b8"),
    "modeling_esm.py": (58205, "f2b003f45d2fa4f94e92d8bbef927b719dfdd7ab7c7a95743daa2b10ab140cb3"),
    "pytorch_model.bin": (391669605, "8b3053eea1b7139144922b5291831128d3bf510737cfad90895a083d444d1fb6"),
...
def read_canonical_sequence(path: Path) -> str:
    ...
    if sequence != CANONICAL_SEQUENCE:
        raise OracleError("canonical NT-v2-100M oracle sequence differs")
    return sequence
...
def main() -> int:
    ...
    with torch.inference_mode():
        ...
        if hidden_states is None or len(hidden_states) != 23:
    ...
    vector_path = output / "nt-v2-100m-ms.independent-oracle-vector.json"
    vector_path.write_bytes(canonical_json(vector))
    npy_path = output / "nt-v2-100m-ms.attention-mask-mean.f32.npy"
...
if __name__ == "__main__":
    try:
        ...
        raise SystemExit("generate_geneb_nt_100m_upstream_oracle: error: %s" % error)
