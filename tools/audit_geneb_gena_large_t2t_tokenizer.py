...
"""Audit pinned GENA-LM-Large-T2T B94 tokenizer parity and B77 relocation."""
...
REVISION = "f997a8a7c1ba5feb6d11de46354a41c51ffe9660"
TOKENIZER_SHA256 = "440cec76fcec5288d10f70b64f3f59289fe313dd1b6fc42bcf0fac319297dc3d"
TOKENIZER_SIZE = 1476210
...
INPUTS = (
    ("canonical", "ACGTNACGTNACGTN", [1, 120, 5428, 120, 5428, 120, 5428, 2]),
    ("second-oracle", "ACGTNNNNNNNNNN", [1, 120, 15, 5, 2]),
    ("b94-raw-mask-and-n-run", "  [MASK]ACGTNNNNNNNNNN  ", [1, 4, 120, 15, 5, 2]),
    ("b94-normalized-gap", "NNNNNNNNNN", [1, 5, 2]),
    ("b94-adjacent-raw-literals", "[MASK][MASK]", [1, 4, 4, 2]),
    ("strip-gap", "  ACGT  ", [1, 120, 15, 2]),
...
def main() -> int:
    ...
    if (
        ...
        or compiled_model.get("literal_token_ids") != [0, 1, 2, 3, 4, 5]
        or len(compiled_model.get("merges", [])) != 31982
    ):
        raise RuntimeError("compiled GENA B94 literal/merge contract differs")
    ...
    report = {
        "schema_version": 1,
        "kind": "geneb-gena-lm-large-t2t-tokenizer-parity-audit",
        "status": "passed",
        "source": {
            "repo": SOURCE_REPO,
            "revision": REVISION,
        ...
        "b94": {
            "raw_input_longest_match_before_gap_normalization": True,
            "source_literal_token_ids": [0, 1, 2, 3, 4, 5],
            "compiled_literal_token_ids": compiled_model["literal_token_ids"],
            "nonliteral_gap_pipeline": [
                "strip-ascii-whitespace",
                "replace-byte-run:N:min-10:with:-",
                "split-isolated:-",
                "bpe",
            ],
            "official_and_native_raw_literal_ids": [1, 4, 120, 15, 5, 2],
            "status": "passed",
        },
        "compiled": {
