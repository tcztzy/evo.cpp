...
"""Generate the pinned NT-v2-250M GENEB vector with official HF code."""
...
RUNTIME_ID = "geneb-nt-v2-250m-ms"
...
CATALOG_CONTRACT_SHA256 = (
    "ef27095e57bf0afc631f448035552fcec268d6c96c732891a06028a5f3862d91"
)
...
EXPECTED_FILES = {
    ...
    "README.md": (6345, "91bc56e596d8e10bcf30e528c81cd58d476b957a6681b3e2a823dc700b3b552b"),
    "config.json": (1064, "234c9a119d8b2b9af2f64b13c2204b559b7a6b6e61dee37af916e0d7e029d154"),
    "esm_config.py": (14876, "a44e859baa08465ecdcd76b0a73f6e4fe011245a212931c403de1149ae9613ec"),
    "jax_model/hyperparams.json": (659, "57bdf49b7ff2d09ad752302178addf78782bfe4acaed5723aa69ed8b494cf991"),
    "jax_model/pytree_ckpt.joblib": (934216899, "0ac579442cba184611c171631fbc91562cd34ece139f54ab48cad5c49025140e"),
    "modeling_esm.py": (58205, "f2b003f45d2fa4f94e92d8bbef927b719dfdd7ab7c7a95743daa2b10ab140cb3"),
    "pytorch_model.bin": (940606173, "ad9be6f4ca8c744dde5794a0cdc443eb2d76d776d9da2377f6d9fe4f4d96fcd9"),
...
def read_canonical_sequence(path: Path) -> str:
    ...
    if sequence != CANONICAL_SEQUENCE:
        raise OracleError("canonical NT-v2-250M oracle sequence differs")
    return sequence
...
def main() -> int:
    ...
    with torch.inference_mode():
        ...
        if list(hidden.shape) != [1, 2048, 768] or hidden.dtype != torch.float32:
    ...
    vector_path = output / "nt-v2-250m-ms.independent-oracle-vector.json"
    vector_path.write_bytes(canonical_json(vector))
    npy_path = output / "nt-v2-250m-ms.attention-mask-mean.f32.npy"
...
if __name__ == "__main__":
    try:
        ...
        raise SystemExit("generate_geneb_nt_250m_upstream_oracle: error: %s" % error)
